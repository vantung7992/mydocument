...
insert into bh_dl_td_dt select c1 ma_dvi,c2 ma_dl,n1 thang,'NTN_GCN' ma_ct,sum(n2) so from temp_1 where n2 is not null
    group by c1,c2,n1;
insert into bh_dl_td_dt select c1 ma_dvi,c2 ma_dl,n1 thang,'NTN_STBH' ma_ct,sum(n3) so from temp_1 where n3 is not null
    group by c1,c2,n1;
...
update temp_2 set n9=round(n7/n8*50,2);
update temp_2 a set n18=(select max(n17) from temp_2 b where a.c6=b.c6);
update temp_2 set n19=round(n17/n18*50,2);
...
-- Tinh diem
update temp_2 a set n8=(select max(n7) from temp_2 b where a.c6=b.c6);
update temp_2 set n9=round(n7/n8*50,2) where n8<>0;
update temp_2 a set n18=(select max(n17) from temp_2 b where a.c6=b.c6);
update temp_2 set n19=round(n17/n18*50,2) where n18<>0;
...
procedure SPM(b_ma_dvi varchar2,b_nsd varchar2,b_pas varchar2,b_dvi varchar2,b_ma_dl varchar2,
    b_ngayd number,b_ngayc number,cs1 out pht_type.cs_type)
AS
    b_loi varchar2(100);
Begin
...
-- Tinh diem
update temp_2 a set n8=(select max(n7) from temp_2 b where a.c6=b.c6);
update temp_2 set n9=round(n7/n8*30,2);
update temp_2 a set n18=(select max(n17) from temp_2 b where a.c6=b.c6);
update temp_2 set n19=round(n17/n18*20,2);
